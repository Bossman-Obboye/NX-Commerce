...
class AddressRepository extends GetxController {
  ...
  Future updateSelectedField(String addressId, bool selected) async {
    try{
      final userId = AuthenticationRepository.instance.authUser!.uid;
  ...
  Future<String> addAddress(AddressModel address) async {
    try {
      final userId = AuthenticationRepository.instance.authUser!.uid;
      final currentAddress = await _db.collection('User').doc(userId).collection('Addresses').add(address.toJson());
