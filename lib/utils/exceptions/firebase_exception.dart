  ...
  String get message {
    switch (code) {
      ...
      case 'permission-denied':
        return 'Permission to perform the operation has been denied! Try again.';
      ...
      case 'missing-phone-number':
        return 'No phone number was provided. Please enter your phone number and try again.';
      case 'invalid-recaptcha-token':
        return 'The reCAPTCHA token provided is invalid or expired. Please try again.';
      case 'invalid-message-payload':
        return 'The message payload provided is invalid. Please check and try again.';
      case 'user-cancelled':
